...
2.  Click on the Filter (![con](/user/image145.png)) button to open
    the filter pane
...
3.  Click on the Filter (![con](/user/image145.png)) button to open
    the filter pane
...
## Clearing the Filter Search
    ...
    2.  Click on *Cross* (![con](/user/image192.png)) button to
...
2.  Click on the *Filter (*![](/user/image145.png)*)* button to
...
> *Reported Completed Date-Time* ![](/user/image199.png)
...
2.  Click on *Cross* (![con](/user/image192.png)) button to close
    the filter pane.
